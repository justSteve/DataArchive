...
export class DatabaseService {
  ...
  getScans(limit: number = 100): ScanInfo[] {
    try {
      ...
      console.error(`[DatabaseService] getScans failed (limit=${limit}):`, error);
      return [];
    }
  }
  ...
  getScan(scanId: number): ScanInfo | undefined {
    try {
      ...
      console.error(`[DatabaseService] getScan failed (scanId=${scanId}):`, error);
      return undefined;
    }
  }
  ...
  getFiles(scanId: number, limit: number = 1000, offset: number = 0): FileInfo[] {
    try {
      ...
      console.error(`[DatabaseService] getFiles failed (scanId=${scanId}, limit=${limit}, offset=${offset}):`, error);
      return [];
    }
  }
  ...
  getFileCount(scanId: number): number {
    try {
      ...
      console.error(`[DatabaseService] getFileCount failed (scanId=${scanId}):`, error);
      return 0;
    }
  }
  ...
  getOSInfo(scanId: number): OSInfo | undefined {
    try {
      ...
      console.error(`[DatabaseService] getOSInfo failed (scanId=${scanId}):`, error);
      return undefined;
    }
  }
  ...
  getDrives(): DriveInfo[] {
    try {
      ...
      console.error(`[DatabaseService] getDrives failed:`, error);
      return [];
    }
  }
  ...
  searchByExtension(scanId: number, extension: string, limit: number = 100): FileInfo[] {
    try {
      ...
      console.error(`[DatabaseService] searchByExtension failed (scanId=${scanId}, extension=${extension}, limit=${limit}):`, error);
      return [];
    }
  }
  ...
  upsertDrive(driveInfo: Partial<DriveInfo>): number {
    try {
      ...
      console.error(`[DatabaseService] upsertDrive failed (serial=${driveInfo.serial_number}):`, error);
      throw error;
    }
  }
  ...
  createScan(driveId: number, mountPoint: string): number {
    try {
      ...
      console.error(`[DatabaseService] createScan failed (driveId=${driveId}, mountPoint=${mountPoint}):`, error);
      throw error;
    }
  }
  ...
  cancelScan(scanId: number): void {
    try {
      ...
      console.error(`[DatabaseService] cancelScan failed (scanId=${scanId}):`, error);
      // Don't rethrow - best effort cancellation
    }
  }
  ...
  getInspections(limit: number = 20, status?: string): any[] {
    try {
      ...
      console.error(`[DatabaseService] getInspections failed (limit=${limit}, status=${status}):`, error);
      return [];
    }
  }
  ...
  getActiveInspections(): any[] {
    try {
      ...
      console.error(`[DatabaseService] getActiveInspections failed:`, error);
      return [];
    }
  }
  ...
  getInspection(sessionId: number): any | undefined {
    try {
      ...
      console.error(`[DatabaseService] getInspection failed (sessionId=${sessionId}):`, error);
      return undefined;
    }
  }
  ...
  startInspection(driveId: number, beadsIssueId?: string): number {
    try {
      ...
      console.error(`[DatabaseService] startInspection failed (driveId=${driveId}, beadsIssueId=${beadsIssueId}):`, error);
      throw error;
    }
  }
  ...
  getInspectionPasses(sessionId: number): any[] {
    try {
      ...
      console.error(`[DatabaseService] getInspectionPasses failed (sessionId=${sessionId}):`, error);
      return [];
    }
  }
  ...
  getInspectionPass(sessionId: number, passNumber: number): any | undefined {
    try {
      ...
      console.error(`[DatabaseService] getInspectionPass failed (sessionId=${sessionId}, passNumber=${passNumber}):`, error);
      return undefined;
    }
  }
  ...
  startPass(sessionId: number, passNumber: number): void {
    try {
      ...
      console.error(`[DatabaseService] startPass failed (sessionId=${sessionId}, passNumber=${passNumber}):`, error);
  ...
  completePass(sessionId: number, passNumber: number, reportJson?: string, errorMessage?: string): void {
    try {
      ...
      console.error(`[DatabaseService] completePass failed (sessionId=${sessionId}, passNumber=${passNumber}):`, error);
      // Don't rethrow - log and continue
    }
  }
  ...
  skipPass(sessionId: number, passNumber: number, reason: string): void {
    try {
      ...
      console.error(`[DatabaseService] skipPass failed (sessionId=${sessionId}, passNumber=${passNumber}):`, error);
      // Don't rethrow - log and continue
    }
  }
  ...
  completeInspection(sessionId: number, status: string = 'completed'): void {
    try {
      ...
      console.error(`[DatabaseService] completeInspection failed (sessionId=${sessionId}, status=${status}):`, error);
      // Don't rethrow - log and continue
    }
  }
  ...
  getDecisions(sessionId: number): any[] {
    try {
      ...
      console.error(`[DatabaseService] getDecisions failed (sessionId=${sessionId}):`, error);
      return [];
    }
  }
  ...
  recordDecision(
    ...
    try {
      ...
      console.error(`[DatabaseService] recordDecision failed (sessionId=${sessionId}, decisionType=${decisionType}):`, error);
      throw error;
    }
  }
  ...
  deleteDecision(sessionId: number, decisionId: number): boolean {
    try {
      ...
      console.error(`[DatabaseService] deleteDecision failed (sessionId=${sessionId}, decisionId=${decisionId}):`, error);
      return false;
    }
  }
  ...
  getDuplicateGroups(sessionId: number, limit: number = 50): any[] {
    try {
      ...
      console.error(`[DatabaseService] getDuplicateGroups failed (sessionId=${sessionId}, limit=${limit}):`, error);
      return [];
    }
  }
}
